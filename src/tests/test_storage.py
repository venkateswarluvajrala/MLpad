...
class TestStorage:
    ...
    def test_should_skip_storage_creation_if_storage_already_exist(self):
        ...
        with patch("src.main.mlpad.notebook.storage.is_persistent_volume_claim_exists") as mock_is_pvc_exists:
            ...
            with patch("src.main.mlpad.notebook.storage.create_pvc") as mock_create_pvc:
                ...
                mock_is_pvc_exists.assert_called_once_with(name=f"{notebook_name}-pvc", namespace=namespace)
    ...
    def test_should_create_storage_if_not_exists(self):
        ...
        with patch("src.main.mlpad.notebook.storage.is_persistent_volume_claim_exists") as mock_is_pvc_exists:
            ...
            with patch("src.main.mlpad.notebook.storage.create_pvc") as mock_create_pvc:
                ...
                mock_is_pvc_exists.assert_called_once_with(name=f'{notebook_name}-pvc', namespace=namespace)
                mock_create_pvc.assert_called_once_with(default_labels=default_labels, notebook_name=notebook_name,
    ...
    def test_should_add_storage_suffix(self):
        ...
        with patch("src.main.mlpad.notebook.storage.client.CustomObjectsApi") as mock_custom_objects_api:
    ...
    def test_should_create_pvc_with_given_values(self):
        ...
        with patch("src.main.mlpad.notebook.storage.client.CoreV1Api") as mock_core_v1_api:
            mock_api_instance = MagicMock()
